...
from recipes_app.recipes.views import CreateRecipesView, EditRecipeView, RecipeDetailsView, DeleteRecipeView, \
    ListRecipesView, SaladsView, SoupsView, AppetizersView, MainDishesView, DessertsView, BakedDishesView, \
    OtherDishesView
